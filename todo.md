...
### 1. 首頁 (Homepage)
-   **[修改]** **英雄區 (Hero Section)**: 強調「您的第一台方程式賽車」或「賽道，從未如此親近」。視覺以賽車在賽道上奔馳為主。
-   **[修改]** **核心服務區 (Features Section)**: 清晰地展示三大核心業務：
    1.  **賽車硬體 (Entry-level Racing Car)**: 突出賽車的設計、性能與安全性。
    2.  **雲端大腦 (Cloud AI)**: 解釋 AI 如何分析數據，優化您的駕駛與車輛設定。
    3.  **駕駛艙視野 (Real-time Dashboard)**: 展示即時數據儀表板的介面與功能。
-   **[修改]** **行動呼籲 (CTA)**: 從「下載白皮書」改為「預約諮詢」、「規格詳情」或「聯絡銷售」。

### 2. 關於我們 (About)
-   **[修改]** **公司使命**: 重新撰寫，強調品牌理念、創辦故事（可以將學生團隊的歷史包裝為起源故事）。
-   **[移除/替換]** **時間軸**: 舊的學生團隊時間軸已不適用。可以替換為展示公司里程碑、或核心團隊介紹。

### 3. 賽車介紹 (The Car)
-   **[新建]** **產品規格頁**: 需要一個專門的頁面詳細介紹賽車。
-   **內容**:
    -   高解析度圖片庫與影片。
    -   詳細的技術規格表（引擎、底盤、空氣動力學等）。
    -   設計理念與安全特性。
    -   選配項目（如果有的話）。

### 4. 技術與服務 (Technology & Services)
-   **[新建]** **服務詳情頁**: 詳細解釋雲端 AI 與儀表板服務。
-   **內容**:
    -   **雲端 AI**: 運作原理、能為客戶解決什麼問題（例如：找出最佳路線、預測零件耗損）、服務方案或訂閱價格。
    -   **即時儀表板**: 功能介紹、UI/UX 設計展示、可客製化選項。

### 5. 合作夥伴 (Partners)
-   **[維持]** 此頁面依然適用，但合作夥伴的性質從「贊助商」變為「技術合作夥伴」（如雲端服務商、零件供應商）或「銷售經銷商」。

### 6. 最新動態 (News)
-   **[維持]** 用於發布公司新聞、賽事活動、技術文章或客戶成功案例。

### 7. 聯絡我們 (Contact)
-   **[修改]** 新增銷售、技術支援等不同部門的聯絡方式。

## 開發待辦事項 (Pivot)

-   [ ] **第一階段：核心資訊調整**
    -   [ ] 更新 `Homepage.jsx` 的文案與內容結構。
    -   [ ] 重新設計 `FeatureSection.jsx` 以展示三大核心業務。
    -   [ ] 更新 `AboutPage.jsx` 的內容，移除舊時間軸。
    -   [ ] 更新 `Navbar.jsx` 的連結文字以符合新架構 (例如：「賽車介紹」、「技術服務」)。
-   [ ] **第二階段：核心頁面開發**
    -   [ ] 開發全新的 `CarPage.jsx`。
    -   [ ] 開發全新的 `ServicesPage.jsx`。
-   [ ] **第三階段：部署與優化**
    -   [x] ~~完成 GitHub Actions CI/CD 設定。~~
